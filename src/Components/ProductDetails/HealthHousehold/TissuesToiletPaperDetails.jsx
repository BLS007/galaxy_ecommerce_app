...
// Importing the Tissues & Toliet Paper Data.
...
const TissuesToiletPaperDetails = () => {
    ...
    const proDetail = TissuesToiletPaperData.filter(x=>x.id == proid.id)
...
export default TissuesToiletPaperDetails;